  ...
  return(
    <div className={`${theme?'bg-blackBg text-white':'bg-white text-black'} min-h-screen`}>
     ...
     <form onSubmit={handleSubmit}>
      <div className={`sm:pr-14 sm:pl-14 pr-4 pl-4 mt-14 border xl:mr-80 xl:ml-80 rounded-lg md:ml-40 md:mr-40 sm:ml-20 sm:mr-20 ml-3 mr-3 hover:shadow-lg ${theme?'hover:shadow-destructive':''}`}>
          <div className={`w-full rounded-md`}> 
            ...
            <div className="w-full mt-1 flex justify-center">
              <input type="text" required className={`${theme?'bg-blackBg text-white':'bg-white text-black'} w-full p-4 h-10 border rounded-md`} placeholder="Enter topic"/>
            </div>
            <p className="ml-1/2 mt-7">Enter Number of questions</p>
            <div className="w-full flex justify-center pt-4">
              <input type="number" min="0" required className={`${theme?'bg-blackBg text-white':'bg-white text-black'} w-full p-4 h-10 border rounded-md`} placeholder="Numer of question"/>
            </div>
